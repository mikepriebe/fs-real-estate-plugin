...
function fsrep_admin_pages() {
	...
	add_submenu_page(__FILE__, 'House Listings', 'Home Listings', 8, 'fsrep_house_listings', 'fsrep_house_listings');
	add_submenu_page(__FILE__, 'Input Fields', 'Input Fields', 8, 'fsrep_fields', 'fsrep_fields');
...
function fsrep_head() {
	...
	echo '<link rel="stylesheet" href="'.get_option('home').'/wp-content/plugins/fs-real-estate/style.css" type="text/css" media="screen" />';
	echo '<link rel="stylesheet" href="'.get_option('home').'/wp-content/plugins/fs-real-estate/lightbox.css" type="text/css" media="screen" />';
	echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/prototype.js"></script>';
	echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/scriptaculous.js?load=effects,builder"></script>';
	echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/lightbox.js"></script>';
	echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/calendarDateInput.js"></script>';
	if (file_exists(ABSPATH.'/wp-content/plugins/fs-real-estate/js/ajax.js')) {
		echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/ajax.js"></script>';
	} else {
		echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/js/ajax.php"></script>';
	}
	if ($FSREPconfig['Google Map API'] != '') {
		echo '<script type="text/javascript" src="'.get_option('home').'/wp-content/plugins/fs-real-estate/gmaps.js"></script>';
    ...
    function makeMap() {
      ...
      var filename = "<?php echo get_option('home'); ?>/wp-content/plugins/fs-real-estate/xml/marker_listings.xml?<?php echo $MarkerListingURL; ?>"
