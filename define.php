...
if ($FSREPconfig['ShowWelcome'] == 'Yes' && !isset($_GET['showwelcome'])) {
	function fsrep_show_welcome() {
		echo '<div class="updated fade">
					...
					<p>Purchase the Professional Version and Membership Extension to unlock all features.</p>
...
if ($FSREPExtensions['ProFeatures'] != FALSE && $FSREPExtensions['ProFeaturesV'] < 1.4) {
	function fsrep_upgrade_pro_message() {
		echo '<div class="error fade">
					<p>Please <a href="http://www.firestormplugins.com/my-account/" target="_blank">download the latest version of the Professional Version</a> to use all features of the FireStorm Real Estate Plugin.</p>
					</div>';
	}
	add_action('admin_notices', 'fsrep_upgrade_pro_message');
	return;
}
