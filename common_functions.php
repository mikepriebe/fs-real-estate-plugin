...
function fssc_add_listing_page() {
	global $wpdb;
	$Pages = array('Listings' => '[fsrep-listings]');
	...
	$wpdb->query("UPDATE ".$wpdb->prefix."fsrep_config SET config_value = '".addslashes($ListingsPageID)."' WHERE config_name = 'ListingsPageID'");
}
