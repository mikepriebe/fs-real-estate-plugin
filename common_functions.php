			...
			if ($RegisterFormError == '') {
				...
				if ($_FILES['image']['name'] != "") {
					...
					if (move_uploaded_file($_FILES['image']['tmp_name'], $uploadfile)) {
						...
						fsrep_imageresizer($uploaddir.basename($_FILES['image']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/'.$ListingID.'.jpg', $FSREPImageSizes->main[0], $FSREPImageSizes->main[1]);
						fsrep_imageresizer($uploaddir.basename($_FILES['image']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/small/'.$ListingID.'.jpg', $FSREPImageSizes->small[0], $FSREPImageSizes->small[1]);
						fsrep_imageresizer($uploaddir.basename($_FILES['image']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/medium/'.$ListingID.'.jpg', $FSREPImageSizes->medium[0], $FSREPImageSizes->medium[1]);
						fsrep_imageresizer($uploaddir.basename($_FILES['image']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/large/'.$ListingID.'.jpg', $FSREPImageSizes->large[0], $FSREPImageSizes->large[1]);
				...
				if (isset($_FILES['aimage']['name'])) {
					if ($_FILES['aimage']['name'] != "") {
						...
						if (move_uploaded_file($_FILES['aimage']['tmp_name'], $uploadfile)) {
							...
							// CONVERT ENLARGED IMAGE TO THUMBNAIL AND STANDARD SIZE
							fsrep_imageresizer($uploaddir.basename($_FILES['aimage']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/additional/'.$ListingID.'-'.$ANumb.'.jpg', $FSREPImageSizes->main[0], $FSREPImageSizes->main[1]);
							fsrep_imageresizer($uploaddir.basename($_FILES['aimage']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/additional/small/'.$ListingID.'-'.$ANumb.'.jpg', $FSREPImageSizes->small[0], $FSREPImageSizes->small[1]);
							fsrep_imageresizer($uploaddir.basename($_FILES['aimage']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/additional/medium/'.$ListingID.'-'.$ANumb.'.jpg', $FSREPImageSizes->medium[0], $FSREPImageSizes->medium[1]);
							fsrep_imageresizer($uploaddir.basename($_FILES['aimage']['name']), ABSPATH.'wp-content/uploads/fsrep/houses/additional/large/'.$ListingID.'-'.$ANumb.'.jpg', $FSREPImageSizes->large[0], $FSREPImageSizes->large[1]);
