...
function fsrep_currency_format($Price) {
	...
	if (!isset($FSREPconfig['PriceTSeparator'])) { $Price = str_replace(',',$FSREPconfig['PriceTSeparator'],$Price); }
	if (!isset($FSREPconfig['PriceCSeparator'])) { $Price = str_replace('.',$FSREPconfig['PriceCSeparator'],$Price); }
	return $Price;
}
