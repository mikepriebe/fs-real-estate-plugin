...
if (isset($success)) {
	...
	<form action="#fsrep-contact-form" id="fsrep-contact-form" method="post" style="margin-bottom: 5px; padding-bottom: 0;">
...
$PageContent .= '<tr><td width="100">&nbsp;</td><td style="text-align: center; padding-top: 5px;"><input name="submit" type="submit" value="Send Message" id="cfsubmit"></td>
</table>
</form>';
