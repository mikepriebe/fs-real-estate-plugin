...
function fsrep_fields() {
	...
	echo '<table class="widefat page fixed" cellspacing="0" border="1">
		...
		foreach($Fields as $Fields) {
			...
			echo '<tr>';
			echo '<td align="center" valign="middle"><a href="admin.php?page=fsrep_fields&f=del&fid='.$Fields->field_id.'"><img src="'.get_option('home').'/wp-content/plugins/fs-real-estate/images/cart-x.png" border="0" alt="X"></a></td>';
			...
			if ($Fields->field_order == 1) {
				echo "<img src=\"".get_option('home')."/wp-content/plugins/fs-real-estate/images/btn-mini-up-g.gif\" border=\"0\" alt=\"UP\"> ";
			} else {
				echo "<a href=\"admin.php?page=fsrep_fields&f=up&fid=".$Fields->field_id."\"><img src=\"".get_option('home')."/wp-content/plugins/fs-real-estate/images/btn-mini-up.gif\" border=\"0\" alt=\"UP\"></a> ";
			}
			// CHECK TO SEE IF THE PRODUCT IS LAST IN LINE
			if ($Fields->field_order == $count) {
				echo "<img src=\"".get_option('home')."/wp-content/plugins/fs-real-estate/images/btn-mini-down-g.gif\" border=\"0\" alt=\"DOWN\"><br />";
			} else {
				echo "<a href=\"admin.php?page=fsrep_fields&f=down&fid=".$Fields->field_id."\"><img src=\"".get_option('home')."/wp-content/plugins/fs-real-estate/images/btn-mini-down.gif\" border=\"0\" alt=\"DOWN\"></a><br />";
			}
