...
function fsrep_settings() {
	...
	echo '<span class="nav-tab'; if ($SettingsPage == 'general') { echo ' nav-tab-active'; } echo '"><a href="admin.php?page=fsrep_settings" style="text-decoration: none; color: #333333;'; if ($SettingsPage == 'general') { echo ' font-weight: bold;'; } echo '">'.fsrep_text_translator('FireStorm Real Estate Plugin', 'General Label', 'General').'</a></span>';
