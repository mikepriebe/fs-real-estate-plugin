            ...
            <div id="misc-publishing-actions" style="border-bottom: none;">
              ...
              <?php }
              	if (function_exists('fsrep_pro_listing_sort')) {
									...
									echo '<div class="misc-pub-section" style="color: #999999;">Sort # (PRO Only)</div>';
								}
							?>
    ...
    <div id="postimagediv" class="postbox ">
      ...
      <div class="inside" style="text-align: center;">
        ...
        if (file_exists($WPUploadDir['basedir'].'/fsrep/houses/medium/'.$_POST['listing_id'].'.jpg')) {
        	echo '<img src="'.$WPUploadDir['baseurl'].'/fsrep/houses/medium/'.$_POST['listing_id'].'.jpg" style="border: 1px solid #999999;"><br /><br />';
        } else {
			...
			if ($_POST['listing_id'] != '0') {
				...
				for ($i=1;$i<=50;$i++) {
					if (file_exists($WPUploadDir['basedir'].'/fsrep/houses/additional/small/'.$_POST['listing_id'].'-'.$i.'.jpg')) {
						echo '<div style="float: left; width: 124px; height: 110px; text-align: center;"><img src="'.$WPUploadDir['baseurl'].'/fsrep/houses/additional/small/'.$_POST['listing_id'].'-'.$i.'.jpg" style="border: 1px solid #999999;"><br /><a href="admin.php?page=fsrep_listings&hid='.$_POST['listing_id'].'&f=edit&iid='.$i.'&if=idel">remove</a></div>';
						$AImages++;
					}
				}
				if ($AImages == 0) {
    ...
    <div id="postimagediv" class="postbox ">
      ...
      <div class="inside">
        ...
        <?php
				...
				echo '<div id="titlediv"><div id="titlewrap"><label class="hide-if-no-js" style="" id="title-prompt-text" for="title">'.$ListingNameLabel.'</label><input type="text" name="listing_label" size="30" tabindex="1" value="'.stripslashes($_POST['listing_label']).'" id="title" autocomplete="off"></div></div>';
				...
				if (function_exists('fsrep_pro_regions_add_form')) { fsrep_pro_regions_add_form($_POST); } else { echo fsrep_print_admin_selectbox_disabled('Region / Neighborhood', 'PRO Feature Only'); }
				...
				if (function_exists('fsrep_pro_listing_child_form')) { fsrep_pro_listing_child_form(); }
