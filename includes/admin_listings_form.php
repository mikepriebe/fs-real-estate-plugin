...
<div id="side-info-column" class="inner-sidebar">
  <div id="side-sortables" class="meta-box-sortables ui-sortable">
    ...
    <div id="postimagediv" class="postbox ">
      <div class="handlediv" title="Click to toggle"><br></div>
      <h3 class="hndle"><span>Google Coordinates</span></h3>
      <div class="inside">
       	<p>Coordinates: <input type="radio" name="listing_auto_coords" value="1" <?php if ($_POST['listing_auto_coords'] == 1) { echo 'checked'; } ?>> Auto &nbsp; <input type="radio" name="listing_auto_coords" value="0" <?php if ($_POST['listing_auto_coords'] == 0) { echo 'checked'; } ?>> Manual</p>
        <p>Longitude:<br/><input type="text" name="listing_long" value="<?php echo $_POST['listing_long']; ?>" size="25"></p>
        <p>Latitude:<br/><input type="text" name="listing_lat" value="<?php echo $_POST['listing_lat']; ?>" size="25"></p>
        <p>Zoom:<br/><input type="text" name="listing_zoom" value="<?php echo $_POST['listing_zoom']; ?>" size="25"></p>
      </div>
    </div>
