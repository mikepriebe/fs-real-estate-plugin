<?php
	...
	$PageContent .= '<h3><a href="'.fsrep_listing_url_gen($Listings->listing_id).'">'.fsrep_listing_name_gen($Listings->listing_id, $FSREPconfig['ListingNameDisplay']).' - '.fsrep_get_address_name($Listings->listing_address_city, 'city').', '.fsrep_get_address_name($Listings->listing_address_province, 'province').'</a></h3>';
	...
	$PageContent .= $FSREPconfig['Currency'].$Listings->listing_price.$CurrencyDisplay.'</span><br />';
