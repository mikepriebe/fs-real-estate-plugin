...
function fsrep_filters() {
	...
	if (isset($_POST['submit'])) {
		if (isset($_POST['filter_name'])) {
			$wpdb->query("INSERT INTO ".$wpdb->prefix."fsrep_filters (filter_name) VALUES ('".$_POST['filter_name']."')");
	...
	echo '<p style="color: red;"><strong>Please note: Custom Filters do not currently support the Type, Value and Map values.</strong></p>';
	...
	echo '<table class="widefat page fixed" cellspacing="0" border="1">
		...
		<th scope="col" class="manage-column" colspan="2">Filter Values</th>
		</tr>
		</thead>
		<tfoot>
		<tr>
