...
function fsrep_filters() {
	...
	echo '<table class="widefat page fixed" cellspacing="0" border="1">
		...
		echo '<td colspan="2"><select name="filter_show_sorting"><option value="1">'.fsrep_text_translator('FireStorm Real Estate Plugin', 'Yes Label', 'Yes').'</option><option value="0">'.fsrep_text_translator('FireStorm Real Estate Plugin', 'No', 'No').'</option></select></td>';
		echo '</tr>';
