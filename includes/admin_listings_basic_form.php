...
echo '<div id="titlediv"><div id="titlewrap">Name: <input type="text" name="listing_label" size="90" tabindex="1" value="'.$_POST['listing_label'].'" id="title" autocomplete="off"></div></div>';
...
<thead>
<tr>
<th scope="col" class="manage-column" width="200"><h3>General Information</h3></th>
...
echo '<table class="widefat page fixed" cellspacing="0" border="1">
	<thead>
	<tr>
	<th scope="col" class="manage-column" width="200">Videos and Slideshows</th>
	<th scope="col" class="manage-column" colspan="2">&nbsp;</th>
	</tr>
	</thead>
	<tbody>';
...
echo '<table class="widefat page fixed" cellspacing="0" border="1">
	<thead>
	<tr>
	<th scope="col" class="manage-column" width="200">Google Coordinates</th>
	<th scope="col" class="manage-column" colspan="2">&nbsp;</th>
	</tr>
	</thead>
	<tbody>';
