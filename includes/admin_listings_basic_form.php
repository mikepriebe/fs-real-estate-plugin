...
echo '<div id="titlediv"><div id="titlewrap">'.fsrep_text_translator('FireStorm Real Estate Plugin', 'Name Label', 'Name').': <input type="text" name="listing_label" size="90" tabindex="1" value="'.$_POST['listing_label'].'" id="title" autocomplete="off"></div></div>';
