<?php
	...
	// $wpdb->query("INSERT INTO ".$table_name." (field_id, field_name, field_value, field_order) VALUES ('1', '".$wpdb->escape('Field Name')."', '".$wpdb->escape('Field Value')."', 1); ");
	...
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (1,'".$wpdb->escape('FireStorm API')."','".$wpdb->escape('')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (2,'".$wpdb->escape('Google Map API')."','".$wpdb->escape('')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (3,'".$wpdb->escape('Listing Type')."','".$wpdb->escape('FSBO')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (4,'".$wpdb->escape('User Listing Limit')."','".$wpdb->escape('1')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (5,'".$wpdb->escape('User Image Limit')."','".$wpdb->escape('10')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (6,'".$wpdb->escape('Map Center Lat')."','".$wpdb->escape('58')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (7,'".$wpdb->escape('Map Center Long')."','".$wpdb->escape('-92')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (8,'".$wpdb->escape('Map Center Zoom')."','".$wpdb->escape('3')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (9,'".$wpdb->escape('Listing Name Display')."','".$wpdb->escape('listing_label - listing_address_city, listing_address_province')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (10,'".$wpdb->escape('Allow Members to List')."','".$wpdb->escape('1')."'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (11,'".$wpdb->escape('Listings Per Page')."','".$wpdb->escape('10')."'); ");
	
	$wpdb->query("ALTER TABLE ".$wpdb->prefix."users ADD user_phone VARCHAR(255) NOT NULL;");
