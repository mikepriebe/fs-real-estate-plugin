...
fsrep_sql_insert($FSREPTableName, 'config_name', 'ExtensionUpdateMsg', 'config_name, config_value', "'ExtensionUpdateMsg', 'Yes'");
fsrep_sql_insert($FSREPTableName, 'config_name', 'Theme', 'config_name, config_value', "'Theme', 'default'");
fsrep_sql_insert($FSREPTableName, 'config_name', 'ImageUploader', 'config_name, config_value', "'ImageUploader', 'classic'");
fsrep_sql_insert($FSREPTableName, 'config_name', 'FSREPDebug', 'config_name, config_value', "'FSREPDebug', 'No'");

fsrep_sql_insert($FSREPTableName, 'config_name', 'ProFeaturesL', 'config_name, config_value', "'ProFeaturesL', ''");
fsrep_sql_insert($FSREPTableName, 'config_name', 'MembershipL', 'config_name, config_value', "'MembershipL', ''");
fsrep_sql_insert($FSREPTableName, 'config_name', 'ImportExportL', 'config_name, config_value', "'ImportExportL', ''");
fsrep_sql_insert($FSREPTableName, 'config_name', 'PaymentsL', 'config_name, config_value', "'PaymentsL', ''");
