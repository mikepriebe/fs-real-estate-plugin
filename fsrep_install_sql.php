...
fsrep_sql_insert($FSREPTableName, 'config_name', 'CountryLabel', 'config_name, config_value', "'CountryLabel', 'Country'");
fsrep_sql_insert($FSREPTableName, 'config_name', 'ProvinceLabel', 'config_name, config_value', "'ProvinceLabel', 'State/Prov.'");
fsrep_sql_insert($FSREPTableName, 'config_name', 'CityLabel', 'config_name, config_value', "'CityLabel', 'City'");
