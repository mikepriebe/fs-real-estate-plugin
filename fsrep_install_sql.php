<?php
	...
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (43,'".$wpdb->escape('ListingsPageID')."',''); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (44,'".$wpdb->escape('GoogleMap')."','1'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (45,'".$wpdb->escape('CountryLabel')."','Country'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (46,'".$wpdb->escape('ProvinceLabel')."','State/Prov.'); ");
	$wpdb->query("INSERT INTO ".$table_name." (config_id, config_name, config_value) VALUES (47,'".$wpdb->escape('CityLabel')."','City'); ");
