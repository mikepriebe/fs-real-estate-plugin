...
- Updated Google geocoded to Version 3.
- Search widget bug fixes.
- Custom checkbox fields can no longer be edited if being used by listings. 
- Misc. bug fixes.
...
- Admin bar no longer shows for subscribers.
- All users set to "administrator" role can add/edit listings.
- Listing details pages now display correct meta titles.
- Resolved missing add_listing_page function error.
- Sorting and page numbers now forward to correct URL on filter pages.
- Price will now be hidden when set to 0.00.
- Misc. bug fixes.

**Version 2.06.08**

- Fixed line 63 error of common_functions.php.
