...
**Version 2.07.01**
- Added repair DB function.

- Misc. bug fixes.


**Version 2.07**
- Sorting options can be removed on filters.
- Can now display contact information and form.

- Flush rewrite rules removed.
